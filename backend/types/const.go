...
var (
	...
	TxTypeWithdrawDelegatorRewards         = "WithdrawDelegatorRewards"
	TxTypeWithdrawValidatorRewards         = "WithdrawValidatorRewards"
	...
	BankList        = []string{TxTypeTransfer}
	DeclarationList = []string{TxTypeStakeCreateValidator, TxTypeStakeEditValidator, TxTypeUnjail}
	StakeList       = []string{TxTypeStakeDelegate, TxTypeBeginRedelegate, TxTypeSetWithdrawAddress, TxTypeStakeBeginUnbonding, TxTypeWithdrawDelegatorReward, TxTypeWithdrawDelegatorRewards, TxTypeWithdrawValidatorRewards}
