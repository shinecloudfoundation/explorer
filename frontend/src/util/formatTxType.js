...
export default class FormatTxType {
		...
		txTypeArray.forEach( item => {
			switch (item) {
				...
				case "WithdrawDelegatorRewards":
					delegationObj.children.push({
						value:'withdrawDelegatorRewards',
						label:'WithdrawDelegatorRewards'
					});
					break;
				...
				case "WithdrawValidatorRewards":
					validationObj.children.push({
						value:'withdrawValidatorRewards',
						label:'WithdrawValidatorRewards'
					});
					break;
				case "SubmitProposal":
	...
	static getRefUrlTxType(txType){
		...
		let UrlTxType = [
			...
			['delegation','withdrawDelegatorRewards'],
			['validation','createValidator'],
			['validation','editValidator'],
			['validation','unjail'],
			['validation','withdrawValidatorRewards'],
			['gov','submitProposal'],
			['gov','deposit'],
			['gov','vote'],
			['others','issueToken'],
