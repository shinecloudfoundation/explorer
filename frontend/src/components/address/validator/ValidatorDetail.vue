    ...
    <div class="transactions_detail_wrap">
        <div :class="[transactionsDetailWrap, 'validator_title']" class="page_title_container">
            <div class="title_tag_content">
                <span class="validator_title_content">{{$t('validator.Details.Name')}}</span>
            ...
            <div class="title_tag_right_content">
                ...
                <div class="status_btn" v-if="validatorStatus === 'Active'">{{$t('validator.Details.Active')}}</div>
                <div
                        class="status_btn"
                        style="background-color: #3DA87E;"
                        v-if="validatorStatus === 'Candidate'"
                >{{$t('validator.Details.Candidate')}}</div>
                <div
                        class="status_btn"
                        style="background-color: #FA7373;"
                        v-if="validatorStatus === 'Jailed'"
                >{{$t('validator.Details.Jailed')}}</div>
            </div>
        </div>
            ...
            <div class="validator_detail_information_wrap">
                <div>
                    <div
                        ...
                        <span class="information_props">{{convertDetailsKey(v[0])}}:</span>
                        <template v-if="v[1]">
        ...
        <div :class="transactionsDetailWrap" class="address_profile">
            <p class="validator_information_content_title">{{$t('validator.Profile.Name')}}</p>
            <div class="validator_detail_information_wrap">
                <div>
                    <div
                        class="information_props_wrap"
                        ...
                        :key="v[0]"
                    >
                        <span class="information_props">{{convertProfileKey(v[0])}}:</span>
        ...
        <div :class="transactionsDetailWrap">
            ...
            >
                <div v-if="txTableList.delegations.total > 0">
                    <p class="validator_information_content_title">{{$t('validator.delegations.Name')}}</p>
                    <div class="delegations_table_container">
                        <m-validator-detail-table
                            :items="convertTxList(txTableList.delegations.items)"
                ...
                >
                    <p class="validator_information_content_title">{{$t('validator.unbondingDelegations.Name')}}</p>
                    <div class="delegations_table_container">
                        <m-validator-detail-table
                            :items="convertTxList(txTableList.unbondingDelegations.items)"
        ...
        <div :class="transactionsDetailWrap">
            ...
            >
                <div v-if="txTableList.depositedProposals.total > 0">
                    <p class="validator_information_content_title">{{$t('validator.depositedProposals.Name')}}</p>
                    <div class="delegations_table_container">
                        <m-validator-detail-table
                            :items="convertTxList(txTableList.depositedProposals.items)"
                ...
                <div v-if="txTableList.votedProposals.total > 0" class="second_table_container">
                    <p class="validator_information_content_title">{{$t('validator.votedProposals.Name')}}</p>
                    <div class="delegations_table_container">
                        <m-validator-detail-table
                            :items="convertTxList(txTableList.votedProposals.items)"
        ...
        >
            <p class="validator_information_content_title">{{$t('validator.transfer.Name')}}</p>
            <div class="blocks_list_table_container">
                <div class="address_tx_list_table">
                    <m-validator-detail-table
                        :items="convertTxList(txTableList.transfers.items)"
                        listName="transfer"
                    ></m-validator-detail-table>
                </div>
            </div>
        ...
        >
            <p class="validator_information_content_title">{{$t('validator.stakes.Name')}}</p>
            <div class="blocks_list_table_container">
                <div class="address_tx_list_table">
                    <m-validator-detail-table :items="convertTxList(txTableList.stakes.items)" listName="stakes"></m-validator-detail-table>
                </div>
            </div>
            <m-pagination
        ...
        >
            <p class="validator_information_content_title">{{$t('validator.declarations.Name')}}</p>
            <div class="blocks_list_table_container">
                <div class="address_tx_list_table">
                    <m-validator-detail-table
                        :items="convertTxList(txTableList.declarations.items)"
        ...
        >
            <p class="validator_information_content_title">{{$t('validator.gov.Name')}}</p>
            <div class="blocks_list_table_container">
                <div class="address_tx_list_table">
                    <m-validator-detail-table :items="convertTxList(txTableList.governance.items)" listName="gov"></m-validator-detail-table>
                </div>
            </div>
            <m-pagination
...
import EchartsLine from "../../home/EchartsLine";
import EchartsValidatorsLine from "../../utilpage/EchartsValidatorsLine";
import EchartsValidatorsUptimeLine from "../../utilpage/EchartsValidatorsUpTimeLine";
...
export default {
    ...
    methods: {
        convertDetailsKey(key){
            let str = "validator.Details." + key.replace(/\s/g, '');;
            return this.$t(str);
        },
        convertProfileKey(key){
            let str = "validator.Profile." + key.replace(/\s/g, '');;
            return this.$t(str);
        },
        ...
        convertTxList(txList){
            ...
            txList.forEach(element => {
                ...
                tx.Tx_Type = this.convertTxType(tx.Tx_Type);
                tx.Tx_Status = this.convertStatus(tx.Tx_Status);
                newTxList.push(tx);
            });
            return newTxList;
        },
                    ...
                    try {
                        if (data) {
                            if (Array.isArray(data) && data[0]) {
                                // TODO, bug found, data has already div 1000000
                                data[0].amount = new BigNumber(data[0].amount).multipliedBy(1000000).toNumber();
                                this.validatorInfo[
                                    "Commission Rewards"
