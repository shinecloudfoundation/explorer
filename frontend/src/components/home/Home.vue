        ...
        <div class="home_container">
                ...
                <ul class="current_net_status_list">
                    <li class="item_status">
                        <div class="img_container">
                            ...
                            <span class="item_name">{{ $t('overview.blockHeight') }}</span>
                        </div>
                    ...
                    <li class="item_status">
                        <div class="img_container">
                            ...
                            <span class="item_name">{{$t('overview.transactions')}}</span>
                        </div>
                    ...
                    <li class="item_status">
                        <div class="img_container">
                            ...
                            <span class="item_name">{{$t('overview.avgBlockTime')}}</span>
                        </div>
                        <p class="current_block" :style="{color:diffSeconds > 120 ? '#ff001b' : ''}">{{averageBlockTime}}</p>
                        <p class="block_time">{{$t('overview.latestBlocks')}}</p>
                    </li>
                ...
                <ul class="current_net_status_list">
                    <li class="item_status">
                        <div class="img_container">
                            ...
                            <span  class="item_name">{{$t('overview.votingPower')}}</span>
                        </div>
                    ...
                    <li class="item_status">
                        <div class="img_container">
                            ...
                            <span class="item_name">{{$t('overview.bondedTokens')}}</span>
                        </div>
                    ...
                    <li class="item_status">
                        <div class="img_container">
                            ...
                            <span class="item_name" style="margin-right: 0.09rem">{{$t('overview.circulationBondedTokens')}}</span>
                            <el-tooltip :content="$t('overview.circulationBondedTokensTips')">
            ...
            <div class="home_module_container">
                <div class="home_module_item fixed_item_height">
                    <home-block-module :moduleName="this.$t('overview.Blocks')" :information="blocksInformation"></home-block-module>
                </div>
                <div class="home_module_item fixed_item_height">
                    <home-block-module :moduleName="this.$t('overview.Transactions')" :information="transactionInformation"></home-block-module>
                </div>
            </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                defaultThemeStyle:['#f18E00', '#f1a010', '#f1ba2d', '#f1cb3b', '#f1d844', '#f1e74c', '#ecf153', '#def15c', '#cdf162', '#c0f165', '#aef167',],
                themeStyleArray:'',
		                ...
		                if(blockList){
			                ...
			                this.blocksInformation = blockList.map(item => {
				                return {
					                ...
					                time:item.time,
					                age: Tools.formatAge(currentServerTime,"",Constant.PREFIX)
				                };
			                });
			                this.blocksTimer = setInterval(function () {
				                ...
				                that.blocksInformation = that.blocksInformation.map(item => {
					                item.age = Tools.formatAge(currentServerTime,item.time,"",Constant.PREFIX);
					                return item
				                })
			                },1000);
		                }
		                ...
		                if(transactionList){
			                ...
			                that.transactionInformation = transactionList.map(item => {
				                ...
				                return {
					                ...
					                Fee,
					                Time: item.time,
					                age: Tools.formatAge(currentServerTime,item.time,"",Constant.PREFIX)
				                };
			                });
                ...
                Service.commonInterface({navigation:{}},(res) => {
                	try {
		                if(res){
			                ...
			                this.validatorValue = `${res.vote_val_num} / ${res.active_val_num} `+this.$t('overview.Validators');
