...
export default {
  data() {
    return {
      ...
      txTypeArr: {
        type_0: ["WithdrawDelegatorRewards", "WithdrawValidatorRewards"],
        type_1: ["Transfer", "Delegate"],
        type_2: ["Burn"],
                  ...
                  if (i === "Amount") {
                    if(data.status === 'success'){
                      if(data.type === "BeginUnbonding" || data.type === 'BeginRedelegate'){
                        fieidValue = `${Tools.numberMoveDecimal(data.tags.amount)} SCDS`
                      }else {
                    ...
                    (this.typeValue === "WithdrawDelegatorRewards" ||
                      this.typeValue === "WithdrawValidatorRewards") &&
                    i === "From"
                  ) {
