<template>
    <div>
        <div class="page_container">
            <page-title :title="$t('overview.BlockChain.Transactions.TransactionList')" :content="`${countNum}`"></page-title>
                            ...
                            <div class="tx_type_content">
                                ...
                                <div class="tx_type_mobile_content">
                                    <el-date-picker  type="date"
                                                     ...
                                                     :placeholder="$t('overview.BlockChain.Transactions.SelectDate')">
                                    </el-date-picker>
                                ...
                                <div class="tx_type_mobile_content">
                                    <div class="search_btn" @click="getFilterTxs">{{$t('overview.BlockChain.Transactions.Search')}}</div>
            ...
            <div class="all_type_list_table_container">
                <div class="all_type_list_table_wrap">
                    ...
                    <m-all-tx-type-list-table :items="convertTxList(allTxTypeList)"></m-all-tx-type-list-table>
            ...
            convertTxList(txList){
                ...
                txList.forEach(element => {
                    let tx = {
                        ...
                        block: element.block,
                        type: this.convertTxType(element.type),
                        fee: element.fee,
                        signer: element.signer,
                        status: this.convertStatus(element.status),
