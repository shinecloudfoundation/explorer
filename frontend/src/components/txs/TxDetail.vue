<template>
    <div class="tx_detail_container">
        ...
        <div class="tx_detail_common_information_content_wrap">
            <div class="tx_detail_header_title">{{$t('txDetail.TransactionInformation')}}</div>
            <div class="tx_detail_common_information_wrap">
                <ul class="tx_detail_common_information_content">
                    <li class="tx_detail_common_information_item">
                        <span class="tx_detail_common_information_item_name">{{$t('txDetail.Block')}} :</span>
                        <div class="tx_detail_common_information_item_value skip_route">
                            <router-link :to="`/block/${blockValue}`">{{blockValue}}</router-link>
                        </div>
                    </li>
                    <li class="tx_detail_common_information_item">
                        <span class="tx_detail_common_information_item_name">{{$t('txDetail.Status')}}  :</span>
                        <div class="tx_detail_common_information_item_value" style="display: flex">
                            <span :style="{color: statusValue === 'Failed' ? '#fa8593' : ''}">{{convertStatus(statusValue)}}</span>
                    ...
                    <li class="tx_detail_common_information_item">
                        <span class="tx_detail_common_information_item_name">{{$t('txDetail.Timestamp')}} :</span>
                        <div class="tx_detail_common_information_item_value">{{timestampValue}}</div>
                    </li>
                    <li class="tx_detail_common_information_item">
                        <span class="tx_detail_common_information_item_name">{{$t('txDetail.Fee')}}  :</span>
                        <div class="tx_detail_common_information_item_value">{{feeValue}}</div>
                    </li>
                    <li class="tx_detail_common_information_item">
                        <span class="tx_detail_common_information_item_name">{{$t('txDetail.GasUsed')}} :</span>
                    ...
                    <li class="tx_detail_common_information_item">
                        <span class="tx_detail_common_information_item_name">{{$t('txDetail.Signer')}} :</span>
                    ...
                    <li class="tx_detail_common_information_item">
                        <span class="tx_detail_common_information_item_name">{{$t('txDetail.Memo')}} :</span>
                        <div class="tx_detail_common_information_item_value">{{memoValue}}</div>
                    </li>
                </ul>
            </div>
            <!--<advertising-space :page-class="'txDetail'"></advertising-space>-->
            <div class="tx_detail_message_content_title">{{$t('txDetail.TransactionMessageOrResult')}}</div>
            <div class="tx_detail_message_information_content">
                <ul class="tx_detail_message_information">
                    <li class="tx_detail_message_information_item" v-for="(item,key) in messageList">
                        <span class="tx_detail_message_information_name" v-if="key !=='tooltip'">{{convertKey(key)}}</span>
                        <div>
                            <div class="tx_detail_message_information_value" :class="key !== 'Commission Rate :'? 'hide_rate_tip' : ''" v-for="value in item">
                            <span v-if="key === 'TxType :'">{{convertTxType(value)}}</span>
                            <span v-if="key !== 'From :'
                            && key !== 'To :'
                            && key !== 'Owner :'
...
<script>
	...
	export default {
        ...
        methods:{
            convertTitle(title){
                let str = "txDetail." + title;
                return this.$t(str);
            },
            convertKey(key){
                let newKey = key.replace(/\s/g, '');
                newKey = newKey.replace(/:/g, '');
                let str = "txDetail.TxResult." + newKey;
                return this.$t(str);
            },
