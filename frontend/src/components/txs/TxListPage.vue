<template>
    <div class="transaction_list_page_container">
        <page-title :title="convertPageTitle(pageTitle)" :content="`${count}`"></page-title>
            ...
            <div class="transaction_list_title_content">
                <div class="filter_container">
                    <div class="filter_tx_type_statue_content">
                        <el-select v-model="value" filterable :change="filterTxByTxType(value)">
                            <el-option v-for="(item, index) in txTypeListArray"
                                       :key="index"
                                       :label="convertTxType(item.label)"
                                       :value="item.value">
                            </el-option>
                        </el-select>
                    ...
                    <div class="reset_search_content">
                        <div class="tx_search_btn" @click="getFilterTxs">{{$t('overview.BlockChain.Transactions.Search')}}</div>
        ...
        <div class="transaction_list_table_container">
            <div class="transaction_list_table_content">
                <div class="table_list_content">
                    <m-tx-list-page-table :items="convertTxList(txList)"></m-tx-list-page-table>
...
<script>
	...
	export default {
		...
		methods: {
            convertPageTitle(pageTitle){
                let str = "overview.BlockChain.Transactions." +pageTitle;
                return this.$t(str);
            },
